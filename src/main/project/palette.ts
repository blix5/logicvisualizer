...
// ProjectData. A golden-angle hue walk gives maximally separated hues for any
// track count without a hand-tuned list; audio and MIDI read as two families.
import type { TrackKind } from '../../shared/model';
